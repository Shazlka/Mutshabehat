...
test('publicSession strips correctChoiceId and choice source metadata', () => {
  const stored: StoredSession = {
    ...
    settings: { mode: 'quick', difficulty: 2, count: 1, scope: { type: 'all' }, questionType: 'mixed' },
    seed: 'secret-seed',
    ...
    questions: [
      {
        ...
        correctChoiceId: 'c1',
        choices: [
          { id: 'c1', text: 'الر تِلْكَ آيَاتُ الْكِتَابِ الْحَكِيمِ', source: { surah: 10, ayah: 1 } },
          { id: 'c2', text: 'طسم تِلْكَ آيَاتُ الْكِتَابِ الْمُبِينِ', source: { surah: 26, ayah: 2 } },
          { id: 'c3', text: 'المر تِلْكَ آيَاتُ الْكِتَابِ', source: { surah: 13, ayah: 1 } },
          { id: 'c4', text: 'حم وَالْكِتَابِ الْمُبِينِ', source: { surah: 43, ayah: 1 } },
        ],
        page: 208,
      },
    ],
...
test('publicSession hides surah/ayah identification before answer and reveals after answer', () => {
  const stored: StoredSession = {
    id: '11111111-1111-1111-1111-111111111111',
    userId: '22222222-2222-2222-2222-222222222222',
    settings: { mode: 'quick', difficulty: 2, count: 1, scope: { type: 'all' }, questionType: 'surah' },
    seed: 'secret-seed',
    startedAt: '2026-09-17T20:00:00Z',
    completedAt: null,
    dailyDate: null,
