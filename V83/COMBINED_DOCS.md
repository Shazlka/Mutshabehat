...
### 9. ☁️ Version 12 Cache-Busters
- Promoted all query-string cache-busters to `v83_upgrades_20260526_5` across styles, scripts, and HTML imports to force immediate browser reloads.
