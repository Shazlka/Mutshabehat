...
def checked_audited_495_498_farsh(page, lines):
    ...
    cases={
      248:[
       ('DOCX-P248-R00395','نُّوحِىٓ','يُوحَى','نافع، ابن كثير، أبو عمرو، ابن عامر، شعبة، الكسائي، أبو جعفر، خلف','بياء الغيب المضمومة وفتح الحاء',1),
       ('DOCX-P248-R00397','تَعْقِلُونَ','يَعْقِلُونَ','جميع القراء عدا نافع، ابن عامر، عاصم، أبو جعفر، يعقوب','بياء الغيب',1),
      ],
      495:[
...
def checked_audited_507_510_farsh(page, lines):
    ...
    cases = {
        ...
        510: [
            ...
            ('DOCX-P510-R03147','السَّلْمِ','ٱلسِّلْمِ','شعبة، حمزة، خلف',35,'بكسر السين',False,qp+'35'),
...
def checked_audited_inline_faces(page, lines):
    ...
    cases = {
        ...
        336: [
            ('DOCX-P336-R01446','فَتَخْطَفُهُ','فَتَخَطَّفُهُ','نافع، أبو جعفر',31,
             'بفتح الخاء وتشديد الطاء'),
            ('DOCX-P336-R01449','يُدَٰفِعُ','يَدْفَعُ','ابن كثير، أبو عمرو، يعقوب',38,
             'بفتح الياء وإسكان الدال بلا ألف'),
        ],
        337: [
            ('DOCX-P337-R01457','دَفْعُ','دِفَاعُ','نافع، أبو جعفر، يعقوب',40,
             'بفتح الفاء وألف بعدها'),
            ('DOCX-P337-R01458','لَّهُدِّمَتْ','لَّهُدِمَتْ','نافع، ابن كثير، أبو جعفر',40,
             'بتخفيف الدال'),
            ('DOCX-P337-R01459','فَكَأَيِّن','فَكَائِن','ابن كثير',45,
             'بالمد والهمز'),
            ('DOCX-P337-R01460','أَهْلَكْنَـٰهَا','أَهْلَكْتُهَا','أبو عمرو، يعقوب',45,
             'بتاء المتكلم'),
        ],
        338: [
            ('DOCX-P338-R01468','تَعُدُّونَ','يَعُدُّونَ','ابن كثير، حمزة، الكسائي، خلف العاشر',47,
             'بياء الغيب'),
            ('DOCX-P338-R01471','مُعَـٰجِزِينَ','مُعَجِّزِينَ','ابن كثير، أبو عمرو',51,
             'بحذف الألف مع تشديد الجيم'),
            ('DOCX-P338-R01472','نَبِيٍّ','نَبِيءٍ','نافع',52,
             'بالهمز'),
            ('DOCX-P338-R01473','أُمْنِيَّتِهِۦ','أُمْنِيَتِهِ','أبو جعفر',52,
             'بتخفيف الياء'),
        ],
        319: [
            ('DOCX-P319-R01280','قُرْءَانًا','قُرَانًا','ابن كثير',113,'بنقل الهمزة'),
        ],
        320: [
            ('DOCX-P320-R01284','بِالْقُرْءَانِ','بِالْقُرَانِ','ابن كثير',114,'بنقل الهمزة'),
            ('DOCX-P320-R01285','يُقْضَىٰٓ إِلَيْكَ وَحْيُهُۥ','نَقْضِيَ إِلَيْكَ وَحْيَهُ','يعقوب',114,'بنون العظمة ونصب الياء والهاء'),
        ...
        303: [
            ...
            ('DOCX-P303-R01067','يَفْقَهُونَ','يُفْقِهُونَ','حمزة، الكسائي، خلف',93,'بضم الياء وكسر القاف'),
            ('DOCX-P303-R01069','خَرْجًا','خَرَاجًا','حمزة، الكسائي، خلف',94,'بألف بعد الراء'),
            ('DOCX-P303-R01062','نُّكْرٗا','نُكُرًا','جميع القراء عدا ابن كثير، أبو عمرو، هشام، حفص، حمزة، الكسائي، خلف',87,'بضم الكاف'),
            ('DOCX-P303-R01063','جَزَآءً الْحُسْنَىٰ','جَزَاءُ الْحُسْنَى','جميع القراء عدا حفص، حمزة، الكسائي، يعقوب، خلف',88,'برفع جزاء من غير تنوين على الإضافة'),
        ...
        289: [
            ('DOCX-P289-R00898','ٱلرِّيحِ','ٱلرِّيَاحِ','أبو جعفر',69,'بالجمع'),
        ],
        290: [
            ('DOCX-P290-R00910','خِلَـٰفَكَ','خَلْفَكَ','نافع، ابن كثير، أبو عمرو، أبو جعفر، خلف العاشر',76,'بفتح الخاء وسكون اللام بلا ألف'),
            ('DOCX-P290-R00911','رُّسُلِنَا','رُسْلِنَا','أبو عمرو',77,'بإسكان السين'),
            ('DOCX-P290-R00913','وَنُنَزِّلُ','وَنُنْزِلُ','أبو عمرو، يعقوب',82,'بتخفيف الزاي'),
            ('DOCX-P290-R00915','وَنَـَٔا','وَنَاءَ','ابن ذكوان، أبو جعفر',83,'بتقديم الألف على الهمزة مع المد المتصل'),
        ],
        272: [
            ('DOCX-P272-R00708','يَرَوْا۟','تَرَوْا','حمزة، الكسائي، خلف',48,'بتاء الخطاب'),
            ('DOCX-P272-R00709','يَتَفَيَّؤُا۟','تَتَفَيَّأُ','أبو عمرو، يعقوب',48,'بتاء التأنيث'),
        ],
        274: [
        ...
        400: [
            ('DOCX-P400-R02084','إِبْرَٰهِيمَ','إِبْرَاهَامَ','هشام',31,
             'بألف بعد الهاء'),
            ('DOCX-P400-R02085','لَنُنَجِّيَنَّهُۥ','لَنُنْجِيَنَّهُ','حمزة، الكسائي، يعقوب، خلف',32,
             'بتخفيف الجيم وسكون النون'),
            ('DOCX-P400-R02087','مُنَجُّوكَ','مُنْجُوكَ','جميع القراء عدا نافع، أبو عمرو، ابن عامر، حفص، أبو جعفر',33,
             'بتخفيف الجيم'),
        ...
        339: [
            ('DOCX-P339-R01478','قُتِلُواْ','قُتِّلُوا','ابن عامر',58,
             'بتشديد التاء'),
        ],
        340: [
            ('DOCX-P340-R01487','عَلَيْهِمْ','عَلَيْهُمُ','حمزة، يعقوب',72,
             'بضم الهاء'),
        ],
        341: [
            ('DOCX-P341-R01494','أَيْدِيهِمْ','أَيْدِيهُمُ','يعقوب',76,
             'بضم الهاء'),
        ],
        327: [
            ('DOCX-P327-R01357','فَسْـَٔلُوهُمْ','فَسَلُوهُمْ','ابن كثير، الكسائي، خلف العاشر',63,
             'بنقل حركة الهمزة وحذفها'),
        ],
        328: [
            ('DOCX-P328-R01372','الرِّيحَ','الرِّيَاحَ','أبو جعفر',81,
             'بالجمع'),
        ],
        329: [
            ('DOCX-P329-R01376','نَّقْدِرَ','يُقْدَرَ','يعقوب',87,
             'بياء الغيب مبنياً للمجهول'),
        ],
        291: [
            ('DOCX-P291-R00920','الْقُرْءَانِ','الْقُرَانِ','ابن كثير',88,
             'بنقل الهمزة'),
            ('DOCX-P291-R00921','تَفْجُرَ','تُفَجِّرَ','نافع، ابن كثير، أبو عمرو، ابن عامر، شعبة، أبو جعفر',90,
             'بتشديد الجيم'),
        ],
        291: [
            ('DOCX-P291-R00922','كِسَفًا','كِسْفًا','جميع القراء عدا نافع، ابن عامر، عاصم، أبو جعفر',92,'بإسكان السين'),
        ],
        292: [
            ('DOCX-P292-R00933','فَسْـَٔلْ','فَسَلْ','ابن كثير، الكسائي، خلف',101,'بنقل الهمزة'),
            ('DOCX-P292-R00934','عَلِمْتَ','عَلِمْتُ','الكسائي',102,
             'بضم التاء'),
        ],
        293: [
            ('DOCX-P293-R00942','وَقُرْءَانًا','وَقُرَانًا','ابن كثير',106,
             'بنقل الهمزة'),
            ('DOCX-P293-R00950','وَيُبَشِّرَ','وَيَبْشُرَ','حمزة، الكسائي',2,
             'بفتح الياء وضم الشين مخففة'),
        ],
        280: [
            ('DOCX-P280-R00785','الْمَيْتَةَ','الْمَيِّتَةَ','أبو جعفر',115,
             'بتشديد الياء'),
        ],
        281: [
            ('DOCX-P281-R00794','إِبْرَٰهِيمَ','إِبْرَاهَامَ','هشام',120,
             'بألف بعد الهاء'),
            ('DOCX-P281-R00798','ضَيْقٍ','ضِيقٍ','ابن كثير',127,
             'بكسر الضاد'),
        ],
        266: [
            ('DOCX-P266-R00628','عَلَيْهِمْ','عَلَيْهُمُ','حمزة، يعقوب',74,
             'بضم الهاء'),
        ],
        276: [
        ...
        278: [
            ('DOCX-P278-R00767','يُنَزِّلُ','يُنْزِلُ','ابن كثير، أبو عمرو',101,
             'بتخفيف الزاي'),
        ...
        250: [
            ('DOCX-P250-R00429','قَبْلِهِم','قَبْلِهُمُ','حمزة، الكسائي، خلف',6,
             'بضم الهاء والميم وصلاً'),
        ],
        295: [
            ('DOCX-P295-R00960','مِّرْفَقٗا','مَرْفِقًا','نافع، ابن عامر، أبو جعفر',16,
             'بفتح الميم وكسر الفاء'),
            ('DOCX-P295-R00969','رُعْبٗا','رُعُبًا','ابن عامر، الكسائي، أبو جعفر، يعقوب',18,
             'بضم العين'),
        ],
        297: [
            ('DOCX-P297-R00990','ثَمَرٌ','ثُمُرٌ','نافع، ابن كثير، ابن عامر، حمزة، الكسائي، خلف العاشر',34,
             'بضمتين'),
        ],
        298: [
            ('DOCX-P298-R01005','الْوَلَـٰيَةُ','الْوِلَايَةُ','حمزة، الكسائي، خلف العاشر',44,
             'بكسر الواو'),
        ],
        324: [
            # The processed source says bare «خلف».  Per project attribution,
            # bare خلف is Khalaf ʿan Hamza (Q06); Q10 must not be inferred.
            ('DOCX-P324-R01319','نُوحِي إِلَيْهِ','نُوحِىٓ إِلَيْهِ','حفص، حمزة، الكسائي',25,
             'بنون العظمة وكسر الحاء'),
        ],
        371: [
        ...
        270: [
            ('DOCX-P270-R00678','تَأْتِيَهُمُ','يَأْتِيَهُمُ','حمزة، الكسائي، خلف',33,'بياء التذكير'),
        ],
        283: [
            ('DOCX-P283-R00816','الْقُرْءَانَ','الْقُرَانَ','ابن كثير',9,'بنقل الهمزة'),
            ('DOCX-P283-R00818','وَيُبَشِّرُ','وَيَبْشُرُ','حمزة، الكسائي',9,'بفتح الياء وضم الشين'),
            ('DOCX-P283-R00821','وَنُخْرِجُ','وَيُخْرَجُ','أبو جعفر',13,'بياء الغيب مبنياً للمجهول'),
            ('DOCX-P283-R00822','وَنُخْرِجُ','وَيَخْرُجُ','يعقوب',13,'بياء الغيب'),
            ('DOCX-P283-R00824','يَلْقَاهُ','يُلَقَّاهُ','ابن عامر، أبو جعفر',13,'بتشديد القاف'),
            ('DOCX-P283-R00825','أَمَرْنَا','آمَّرْنَا','يعقوب',16,'بمد الهمزة وتشديد الميم'),
        ],
        284: [
            ('DOCX-P284-R00834','يَبْلُغَنَّ','يَبْلُغَانِّ','حمزة، الكسائي، خلف العاشر',23,'على التثنية'),
        ],
        285: [
            ('DOCX-P285-R00846','خِطْـٔٗا','خِطَاءً','ابن كثير',31,'بفتح الطاء ومد الهمزة'),
            ('DOCX-P285-R00847','خِطْـٔٗا','خَطَأً','ابن ذكوان، أبو جعفر',31,'بفتح الخاء والطاء'),
            ('DOCX-P285-R00848','فَلَا يُسْرِف','فَلَا تُسْرِف','حمزة، الكسائي، خلف',33,'بتاء الخطاب'),
        ],
        286: [
            ('DOCX-P286-R00856','الْقُرْءَانِ','الْقُرَانِ','ابن كثير',41,'بنقل الهمزة'),
            ('DOCX-P286-R00859','عَمَّا يَقُولُونَ','عَمَّا تَقُولُونَ','حمزة، الكسائي، خلف',43,'بتاء الخطاب'),
            ('DOCX-P286-R00860','تُسَبِّحُ لَهُ','يُسَبِّحُ لَهُ','نافع، ابن كثير، ابن عامر، أبو جعفر',44,'بياء التذكير'),
            ('DOCX-P286-R00861','فِيهِنَّ','فِيهُنَّ','يعقوب',44,'بضم الهاء'),
        ],
        299: [
            ('DOCX-P299-R01015','نُسَيِّرُ ٱلْجِبَالَ','نُسَيِّرُ الْجِبَالَ',
             'نافع، عاصم، حمزة، الكسائي، أبو جعفر، يعقوب، خلف',47,'بنون العظمة'),
            ('DOCX-P299-R01015','نُسَيِّرُ الْجِبَالَ','نُسَيِّرُ الْجِبَالَ','نافع، عاصم، حمزة، الكسائي، أبو جعفر، يعقوب، خلف',47,'بنون العظمة'),
        ],
        300: [
            ('DOCX-P300-R01028','قُبُلًا','قُبُلًا','عاصم، حمزة، الكسائي، أبو جعفر، خلف',55,'بضمتين'),
            ('DOCX-P300-R01029','هُزُوًا','هُزْءًا','حمزة، خلف',56,'بضم فسكون مهموزًا'),
        ],
        301: [
            ('DOCX-P301-R01045','نُّكْرًا','نُكُرًا','نافع، ابن عامر، أبو جعفر، يعقوب',74,'بضم الكاف'),
        ],
        302: [
            ('DOCX-P302-R01054','لَّتَّخَذْتَ','لَتَخِذْتَ','ابن كثير، أبو عمرو، يعقوب',77,'بكسر التاء وتخفيف الخاء'),
            ('DOCX-P302-R01055','يُبْدِلَهُمَا','يُبَدِّلَهُمَا','نافع، أبو عمرو، أبو جعفر',81,'بتشديد الدال'),
            ('DOCX-P302-R01056','رُحْمٗا','رُحْمًا','الجمهور',81,'بإسكان الحاء'),
        ],
        316: [
            ('DOCX-P316-R01236','يُخَيَّلُ','تُخَيَّلُ','ابن ذكوان، روح',66,'بتاء التأنيث'),
        ],
        317: [
            ('DOCX-P317-R01260','حُمِّلْنَا','حَمَلْنَا','أبو عمرو، شعبة، حمزة، الكسائي، روح، خلف',87,'بفتح الحاء والميم مخففة'),
        ],
        331: [
            ('DOCX-P331-R01402','قَالَ رَبِّ','قُل رَّبُّ','أبو جعفر',112,'بفعل أمر وضم الباء'),
        ],
        332: [
            ('DOCX-P332-R01409','وَرَبَتْ','وَرَبَأَتْ','أبو جعفر',5,'بالهمز'),
        ],
        333: [
            ('DOCX-P333-R01415','لِيُضِلَّ','لِيَضِلَّ','ابن كثير، أبو عمرو، رويس',9,'بفتح الياء'),
            ('DOCX-P333-R01416','ثُمَّ لْيَقْطَعْ','ثُمَّ لِيَقْطَعْ','قالون، ابن كثير، عاصم، حمزة، الكسائي، أبو جعفر، روح، خلف',15,'بكسر اللام'),
        ],
        334: [
            ('DOCX-P334-R01422','وَالصَّـٰبِـِٔينَ','وَالصَّابِينَ','نافع، أبو جعفر',17,'بحذف الهمزة'),
            ('DOCX-P334-R01427','وَلُؤْلُؤٗا','وَلُؤْلُؤًا','نافع، عاصم، أبو جعفر، يعقوب',23,'بالنصب'),
        ],
        364: [
        ...
        552: [
            ...
            ('DOCX-P552-R03538','سِحْرٌ','سَاحِرٌ','حمزة، الكسائي، خلف',6,'بفتح السين وألف مدية وكسر الحاء'),
        ...
        560: [
            ...
            ('DOCX-P560-R03613','وَجِبْرِيلُ','وَجَبْرَئِيلَ','حمزة، الكسائي، خلف',4,
        ...
        556: [
            ...
            ('DOCX-P556-R03576','يَجْمَعُكُمْ','نَجْمَعُكُمْ','يعقوب',9,
             'بنون العظمة'),
            ('DOCX-P556-R03577','يُكَفِّرْ','نُكَفِّرْ','نافع، ابن عامر، أبو جعفر',9,
             'بنون العظمة'),
            ('DOCX-P556-R03577','وَيُدْخِلْهُ','وَنُدْخِلْهُ','نافع، ابن عامر، أبو جعفر',9,
             'بنون العظمة'),
        ],
        558: [
        ...
        326: [
            ('DOCX-P326-R01350','وَلَا يَسْمَعُ الصُّمُّ','وَلَا تُسْمِعُ الصُّمَّ','ابن عامر',45,
             'بتاء الخطاب وكسر الميم'),
        ...
        300: [
            ...
            ('DOCX-P300-R01028','قُبُلًا','قُبُلًا','عاصم، حمزة، الكسائي، أبو جعفر، خلف',55,
             'بضمتين'),
            ('DOCX-P300-R01029','هُزُوًا','هُزْءًا','حمزة، خلف',56,
             'بضم فسكون مهموزًا'),
        ...
        301: [
            ...
            ('DOCX-P301-R01044','زَكِيَّةً','زَاكِيَةً','نافع، ابن كثير، أبو عمرو، أبو جعفر، رويس',74,
             'بالألف بعد الزاي'),
            ('DOCX-P301-R01045','نُّكْرًا','نُكُرًا','نافع، ابن عامر، أبو جعفر، يعقوب',74,
             'بضم الكاف'),
        ],
        302: [
            ('DOCX-P302-R01056','رُحْمًا','رُحُمًا','ابن عامر، أبو جعفر، يعقوب',81,
             'بضم الحاء'),
            ('DOCX-P302-R01054','لَتَّخَذْتَ','لَتَخِذْتَ','ابن كثير، أبو عمرو، يعقوب',77,
             'بكسر التاء وتخفيف الخاء'),
            ('DOCX-P302-R01055','يُبْدِلَهُمَا','يُبَدِّلَهُمَا','نافع، أبو عمرو، أبو جعفر',81,
             'بتشديد الدال'),
        ],
        304: [
    ...
    performance_faces={
        ...
        279: [
            ...
            ('DOCX-P279-R00779','لَا يَهْدِيهِمُ اللَّهُ','حمزة، الكسائي، يعقوب، خلف',104,'بضم الهاء والميم وصلاً','https://quranpedia.net/qiraat/an-nahl/104','وجه الضم وصلاً؛ «خلف» المجرد هو خلف عن حمزة Q06.'),
        ],
        280: [
            ('DOCX-P280-R00787','فَمَنِ اضْطُرَّ','أبو عمرو، عاصم، حمزة، يعقوب',115,'بكسر النون وضمة الطاء وصلاً','https://quranpedia.net/qiraat/an-nahl/115','وجه المصدر بالكسر وصلاً.'),
        ],
        261: [
