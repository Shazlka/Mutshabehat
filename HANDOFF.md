...
— pages 1–244 plus all of سورتي مريم وطه (pages 305–321) are imported
(1,392 variants, 6,459 أصول rulings across 261 pages),
...
- **Visual review of the imported pages (1–244 and 305–321) is the user's next activity.** Open the reader in مقارنة القراءات,
...
- **343 pages left to import** (245–304 and 322–604). The page table is deliberately **not**
...
- **سورتا مريم وطه came from different sources** — user-supplied ayah-by-ayah tables, not the PDF —
